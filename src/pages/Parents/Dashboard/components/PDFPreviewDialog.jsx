  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] w-[95vw] h-[90vh] flex flex-col p-0 overflow-hidden gap-0 border-none shadow-2xl">
        ...
        {/* PDF Viewer Container - Expandable */}
        <div className="flex-1 bg-slate-100 relative group">
          {/* Subtle loading indicator / background text */}
          ...
          <iframe
            src={`${previewUrl}#toolbar=0`} // #toolbar=0 hides the internal browser UI for a cleaner look

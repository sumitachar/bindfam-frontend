        ...
        <CardContent className={`p-2 ${isSmallScreen ? "p-1.5" : ""}`}>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                {entity?.role || type.charAt(0).toUpperCase() + type.slice(1)}
              </p>
            </div>
          </div>

          {status === "linked" && type === "doctor" && permissions && (
            <div
                ...
                {[
                  ...
                  <label key={perm} className="flex items-center space-x-1.5">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        onPermissionChange?.(entity.userCode, perm)
                      }
                      disabled={loading}
          ...
          {status === "pending" && (
            ...
            >
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    onAction?.(
                      "accept",
                      type === "parent" ? entity.connectionId : entity.userCode
                    )
                  }
                  disabled={loading}
                >
              ...
              >
                <Button
                  className={`button-secondary text-text flex-1 rounded-lg shadow-soft hover:shadow-lg transition-all ${
                    isSmallScreen ? "text-xs py-1" : "text-sm py-1.5"
                  }`}
                  onClick={() =>
                    onAction?.(
